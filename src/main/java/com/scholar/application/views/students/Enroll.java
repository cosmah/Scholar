...
public class Enroll extends VerticalLayout {
    ...
    @Autowired
    public Enroll(EnrollmentService enrollmentService) {
        ...
        dobField = new DatePicker("Date of Birth"); // Use DatePicker instead of TextField
        ...
        subjectsField = new TextField("Subjects");

        Button enrollButton = new Button("Enroll Student", event -> {
            try {
                logger.info("Attempting to enroll student...");
                LocalDate dob = dobField.getValue(); // No need to parse since DatePicker handles it
